...
namespace FabricsLib
{
    public class BankTrasaction
    {
        ...
        internal BankTrasaction(long senderID, long receiverID, decimal value, DateTime timeExecuted)
        {
        ...
        internal BankTrasaction(long senderID, long receiverID, decimal value)
        {
            ID = counterID++;
            this.senderID = senderID;
            this.receiverID = receiverID;
